    ...
    <div class="main-wrapper">
        <div class="inner-wrapper">
            <div class="footer">
                ...
                <a href="#" data-modal-open="" class="impressum">Imprint</a>
            </div>
        </div>
    </div>
</footer>
    ...
    <div class="main-wrapper">
        <div class="inner-wrapper">
            <div class="modal">
                ...
                <h4>Information in accordance with §5 TMG</h4>

                White Leaf</br>
                Contact Information</br>
                E-Mail: info@whiteleaf.de</br>
                Internet address: www.whiteleaf.de
